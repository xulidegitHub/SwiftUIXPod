...
open class UIHostingScrollView<Content: View>: UIScrollView, UIScrollViewDelegate, UIGestureRecognizerDelegate, _AppKitOrUIKitHostingScrollViewType {
    ...
    private let shouldRecognizeSimultaneously: Bool
    ...
    public init(rootView: Content, shouldRecognizeSimultaneously: Bool) {

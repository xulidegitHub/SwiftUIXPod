...
>: UICollectionViewCell {
    ...
    var configuration: ContentHostingController.Configuration {
        ...
        return .init(
            ...
            _cellProxyBase: _CustomCellProxyBase(base: self),
...
//        _assignIfNotEqual(false, to: &super.isSelected)
    ...
    override func apply(_ layoutAttributes: UICollectionViewLayoutAttributes) {
        ...
        contentHostingController?.rootView.configuration._cellProxyBase = _CustomCellProxyBase(base: self)
...
extension CocoaHostingCollectionViewCell {
    ...
    struct _CustomCellProxyBase: _CellProxyBase {
